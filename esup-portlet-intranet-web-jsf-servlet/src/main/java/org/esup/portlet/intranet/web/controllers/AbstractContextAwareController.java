 ...
 * http://sourcesup.cru.fr/projects/esup-portlet-intranet
 */
package org.esup.portlet.intranet.web.controllers;
...
public abstract class AbstractContextAwareController extends AbstractDomainAwareBean {
	...
	/**
	 * @see org.esup.portlet.intranet.web.controllers.AbstractDomainAwareBean#afterPropertiesSetInternal()
	 */
	@Override
	...
	/**
	 * @see org.esup.portlet.intranet.web.controllers.AbstractDomainAwareBean#getCurrentUser()
	 */
	@Override
